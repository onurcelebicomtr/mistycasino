...
function clearEditor() {
  ...
  document.getElementById('post-author').value = 'Misty Casino';
  ...
  document.getElementById('seo-prev-title').textContent = 'Baslik buraya gelecek - Misty Casino';
  document.getElementById('seo-prev-url').textContent = 'mistycasino.com/yazilar/url-slug';
...
function editPost(id) {
  ...
  .then(posts => {
    ...
    document.getElementById('post-author').value = p.author || 'Misty Casino';
...
// PAGE CONTENT (Ana Sayfa / Misty Casino Giris)
...
function savePageContent(type) {
  ...
  const data = {
    title: title,
    slug: type === 'homepage' ? 'ana-sayfa' : 'mistycasino-giris',
  ...
  .then(d => {
    if (d.success) {
      toast(type === 'homepage' ? 'Ana sayfa icerigi kaydedildi!' : 'Misty Casino Giris icerigi kaydedildi!');
...
function updateSeoPreview() {
  ...
  document.getElementById('seo-prev-title').textContent = title + ' - Misty Casino';
  document.getElementById('seo-prev-url').textContent = 'mistycasino.com/yazilar/' + slug;
