...
const ADMIN_PASS = 'mistycasino2025';
  ...
  if (pathname === '/api/posts.php') {
    ...
    if (method === 'POST') {
      ...
      const post = {
        ...
        category: input.category || '', author: input.author || 'Misty Casino',
...
server.listen(PORT, () => {
  console.log(`\n  🟢 Misty Casino Blog çalışıyor!\n`);
  console.log(`  🌐 Site:   http://localhost:${PORT}`);
  console.log(`  🔧 Panel:  http://localhost:${PORT}/admin/`);
  console.log(`  👤 Giriş:  admin / mistycasino2025\n`);
});
